...
detect_own() {
  ...
  # agy (Antigravity CLI) sets ANTIGRAVITY_AGENT=1 for its child processes
  # (verified, agy 1.1.10), alongside ANTIGRAVITY_CONVERSATION_ID and
  # ANTIGRAVITY_LS_VERSION. It sets no Claude-compatible marker.
  ...
  for _ in 1 2 3 4 5 6 7 8; do
    ...
    case "$(basename -- "$comm")" in
      ...
      *grok*) echo grok; return ;;
      ...
      # Matched exactly, never as a substring: "agy" is a fragment of ordinary
      # command names such as `legacy` or `magyar`.
      agy) echo agy; return ;;
