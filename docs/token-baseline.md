...
Three properties are worth stating because they are what make the board usable rather than merely present.
...
**It stops honestly.**
The board is generated by a plain loop the captain or firstmate starts - no daemon, no port, no watcher integration - and its pages carry a loud stale banner that fires as soon as the feed stops advancing.
